...
export class ActivityService {
  ELEMENT_DATA: Partial<Activity>[] = [
    {id: 1, point: 'SWAY', description: 'CONFERIR ESTADO DE CONSERVAÇÃO DOS PINOS E FUNCIONAMENTO DAS LÂMPADAS DOS SENSORES', activityType: 'Conectores da mesa', frequency: 'Diária'},
    {id: 2, point: 'NOVO TECTOR', description: 'CONFERIR FUNCIONAMENTO DO BOTÃO DE TRAVA', activityType: 'Conectores da mesa', frequency: 'Semanal'},
