...
export class ActivityService {
  ELEMENT_DATA: Partial<Activity>[] = [
    ...
    {id: 2, point: 'NOVO TECTOR', description: 'CONFERIR FUNCIONAMENTO DO BOTÃO DE TRAVA', activityType: 'Conectores da mesa', frequency: 'Semanal', sop: './uploads/SOP - COLAGEM DO PARABRISA - VOZ AM 017.pdf'},
